...
bool MariadbConnector::IsConnected() const { return m_isConnected; }
...
DatabaseResultTable
MariadbConnector::GetTableSchema(const std::string &tableName) {
...
MariadbConnector::~MariadbConnector() { Disconnect(); }
